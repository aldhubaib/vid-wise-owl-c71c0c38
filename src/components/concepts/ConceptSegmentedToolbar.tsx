...
export default function ConceptSegmentedToolbar() {
  ...
  return (
    <div className="rounded-xl bg-background border border-border overflow-hidden">
      {/* Segmented toolbar — groups separated by vertical dividers */}
      <div className="px-4 py-2.5 flex items-center justify-between border-b border-border">
        <div className="flex items-center">
          ...
          {/* Segment 3: Duration */}
          <div className="flex items-center gap-1.5 px-3 text-[12px] text-dim">
